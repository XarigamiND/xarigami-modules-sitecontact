...
function sitecontact_sitecontactblock_display($blockinfo)
{
    ...
    if (($returnedform != 1) || ($item['isvalid'] == FALSE)) {
        ...
        $item['fieldconfig'] =isset($item['fieldconfig'])?$item['fieldconfig']:'';
        $item['fieldconfig'] = explode(',',$item['fieldconfig']);
        ...
        $item['webconfirmtext']=$webconfirmtext;
